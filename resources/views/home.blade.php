    ...
    <section class="services-w3l-block py-5" id="features">
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-md-5 mb-4" style="max-width:500px;">
                ...
                <h3 class="title-style">Achieve Your Goals With G1 School</h3>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch">
                    <div class="icon-box icon-box-clr-1">
                        <div class="icon"><i class="fas fa-user-friends"></i></div>
                        <h4 class="title"><a>Expert Teachers</a></h4>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mt-md-0 mt-4">
                    <div class="icon-box icon-box-clr-2">
                        ...
                        <h4 class="title"><a>Quality Education</a></h4>
            ...
            <div class="row pb-xl-5 align-items-center">
                <div class="col-lg-6 position-relative home-block-3-left pb-lg-0 pb-5">
                    <div class="position-relative">
                        <img src="{{ asset("images/img1.jpg") }}" alt="" class="img-fluid radius-image">
                    </div>
                    <div class="imginfo__box">
                        ...
                        <a href="tel:http://+8557654321"><i class="fas fa-phone-alt"></i>+855-856-4321</a>
                    </div>
                </div>
                <div class="col-xl-5 col-lg-6 offset-xl-1 mt-lg-0 mt-5 pt-lg-0 pt-5">
                    ...
                    <a href="{{ url("/contact") }}" class="btn btn-style mt-5">Apply Now</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row content23-col-2 text-center">
                <div class="col-md-6">
                    <div class="content23-grid content23-grid1">
                        <h4><a href="{{ url("/about") }}">Expert Teachers</a></h4>
                    </div>
                </div>
                <div class="col-md-6 mt-md-0 mt-4">
                    <div class="content23-grid content23-grid2">
                        <h4><a href="{{ url("/about") }}">Safe Environment</a></h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container pb-md-5 pb-4">
            ...
            <div class="row text-center pt-4">
                <div class="col-md-3 col-6">
                    <div class="counter">
                        <img src="{{ asset("images/icon-1.png") }}" alt="" class="img-fluid">
                        <div class="timer count-title count-number mt-sm-1" data-to="{{ $numberOfStudents }}" data-speed="500"></div>
                        <p class="count-text">Current Students</p>
                    </div>
                </div>
                <div class="col-md-3 col-6">
                    <div class="counter">
                        <img src="{{ asset("images/icon-2.png") }}" alt="" class="img-fluid">
                        <div class="timer count-title count-number mt-3" data-to="{{ $numberOfDepartments }}" data-speed="500"></div>
                        <p class="count-text">Our Departments</p>
                    </div>
                </div>
                <div class="col-md-3 col-6 mt-md-0 mt-5">
                    <div class="counter">
                        <img src="{{ asset("images/icon-3.png") }}" alt="" class="img-fluid">
                        <div class="timer count-title count-number mt-3" data-to="{{ $numberOfCourses }}" data-speed="500"></div>
                        <p class="count-text">Total Courses</p>
                    </div>
                </div>
                <div class="col-md-3 col-6 mt-md-0 mt-5">
                    <div class="counter">
                        <img src="{{ asset("images/icon-4.png") }}" alt="" class="img-fluid">
                        <div class="timer count-title count-number mt-3" data-to="{{ $numberOfTeachers }}" data-speed="500"></div>
            ...
            <div class="content-slider text-center">
                <div class="clients-slider">
                    <div class="mask">
                        <ul>
                            <li class="anim1">
                                <img src="{{ asset("images/testi1.jpg") }}" class="img-fluid rounded-circle"
                                     alt="client image" />
                            ...
                            <li class="anim2">
                                <img src="{{ asset("images/testi2.jpg") }}" class="img-fluid rounded-circle"
                                     alt="client image" />
                            ...
                            <li class="anim3">
                                <img src="{{ asset("images/testi3.jpg") }}" class="img-fluid rounded-circle "
                                     alt="client image" />
    ...
    <div class="w3l-grids-block-5 home-course-bg py-5" id="courses">
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-md-5 mb-4" style="max-width:500px;">
                ...
                <h3 class="title-style">Wide variety of Courses for you</h3>
            </div>
            ...
            <div class="text-center mt-sm-5 mt-4 pt-sm-0 pt-1">
                <a href="{{ url("/courses") }}" class="btn btn-style btn-style-secondary mt-sm-3">
                ...
                <div class="right-content-call mt-lg-0 mt-4">
                    <ul class="buttons">
                        <li class="phone-sec me-lg-4"><i class="fas fa-phone-volume"></i>
                            <a class="call-style-w3" href="tel:+855 456 789 0000">+855 673 458 1111</a>
                        </li>
                        <li><a href="{{ url("/courses") }}" class="btn btn-style btn-style-2 mt-lg-0 mt-3">Join for free</a>
                        </li>
                    </ul>
                </div>
            </div>
