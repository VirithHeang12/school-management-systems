        ...
        <div class="container pt-md-4">
            <div class="row footer-top-29">
                <div class="col-lg-4 col-md-6 footer-list-29">
                    ...
                    <p class="mb-2 pe-xl-5">Address : G1 School, 1250, Street 76, Kakab, Posenchey, Phnom Penh, Cambodia.
                    </p>
                    <p class="mb-2">Phone Number : <a href="tel:+1855 234 4567">+855 673 4587</a></p>
                    <p class="mb-2">Email : <a href="mailto:info@g1school.com">info@g1school.com</a></p>
                </div>
                <div class="col-lg-2 col-md-3 col-6 footer-list-29 mt-md-0 mt-4">
                    <ul>
                        ...
                        <li><a href="{{ url("/contact") }}">Become a Teacher</a></li>
                ...
                <div class="col-lg-2 col-md-3 col-6 ps-lg-5 ps-lg-4 footer-list-29 mt-md-0 mt-4">
                    <ul>
                        ...
                        <li><a href="{{ url("/contact") }}">Contact Us</a></li>
                        <li><a href="{{ url("/contact") }}">License & uses</a></li>
                        <li><a href="{{ url("/courses") }}">Courses</a></li>
                    </ul>
                </div>
            ...
            <!-- copyright -->
            <p class="copy-footer-29 text-center pt-lg-2 mt-5 pb-2">© 2024 G1 School. All rights reserved.
            <!-- //copyright -->
        </div>
    </div>
</footer>
